...
class Map:
    ...
    def make_map(self, image):
        ...
        sprites.extend(wall_1.get_obstacle(self.grid_list[3][9], 36, image))
        sprites.extend(wall_3.get_obstacle(self.grid_list[10][9], 36, image))
        sprites.extend(wall_4.get_obstacle(self.grid_list[10][21], 36, image))
        sprites.extend(wall_2.get_obstacle(self.grid_list[3][21], 36, image))

        sprites.extend(wall_E.get_obstacle(self.grid_list[7][14], 36, image))
        sprites.extend(wall_E.get_obstacle(self.grid_list[6][17], 36, image))

        sprites.extend(wall_D.get_obstacle(self.grid_list[1][15], 36, image))
        sprites.extend(wall_D.get_obstacle(self.grid_list[1][16], 36, image))

        sprites.extend(wall_A.get_obstacle(self.grid_list[2][4], 36, image))
        sprites.extend(wall_C.get_obstacle(self.grid_list[1][5], 36, image))

        sprites.extend(wall_A.get_obstacle(self.grid_list[14][26], 36, image))
        sprites.extend(wall_C.get_obstacle(self.grid_list[13][27], 36, image))

        sprites.extend(wall_4.get_obstacle(self.grid_list[12][13], 36, image))
        sprites.extend(wall_3.get_obstacle(self.grid_list[12][17], 36, image))

        sprites.extend(wall_G.get_obstacle(self.grid_list[5][19], 36, image))
        sprites.extend(wall_H.get_obstacle(self.grid_list[9][19], 36, image))
        sprites.extend(wall_G.get_obstacle(self.grid_list[9][11], 36, image))
        sprites.extend(wall_H.get_obstacle(self.grid_list[5][11], 36, image))

        sprites.extend(wall_A.get_obstacle(self.grid_list[14][4], 36, image))
        sprites.extend(wall_C.get_obstacle(self.grid_list[13][5], 36, image))

        sprites.extend(wall_A.get_obstacle(self.grid_list[2][26], 36, image))
        sprites.extend(wall_C.get_obstacle(self.grid_list[1][27], 36, image))

        sprites.extend(wall_5.get_obstacle(self.grid_list[5][6], 36, image))
        sprites.extend(wall_7.get_obstacle(self.grid_list[9][6], 36, image))
        sprites.extend(wall_6.get_obstacle(self.grid_list[5][3], 36, image))
        sprites.extend(wall_8.get_obstacle(self.grid_list[9][3], 36, image))

        sprites.extend(wall_5.get_obstacle(self.grid_list[5][28], 36, image))
        sprites.extend(wall_7.get_obstacle(self.grid_list[9][28], 36, image))
        sprites.extend(wall_6.get_obstacle(self.grid_list[5][25], 36, image))
        sprites.extend(wall_8.get_obstacle(self.grid_list[9][25], 36, image))
